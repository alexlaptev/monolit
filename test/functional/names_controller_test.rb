...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { color: @name.color, description: @name.description, img_url: @name.img_url, price: @name.price, size: @name.size, sub_category_id: @name.sub_category_id }
    end
  ...
  test "should update name" do
    put :update, id: @name, name: { color: @name.color, description: @name.description, img_url: @name.img_url, price: @name.price, size: @name.size, sub_category_id: @name.sub_category_id }
    assert_redirected_to name_path(assigns(:name))
  end
